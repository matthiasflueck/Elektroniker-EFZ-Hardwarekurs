# 15.2 – Zähler, Teiler und Schieberegister

[← Zurück](01-latch-flipflop-und-zustandsbegriff.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](03-endliche-zustandsautomaten.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Zähler, Teiler und Schieberegister** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
