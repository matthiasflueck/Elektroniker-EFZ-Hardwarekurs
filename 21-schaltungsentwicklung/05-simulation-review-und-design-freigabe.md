# 21.5 – Simulation, Review und Design-Freigabe

[← Zurück](04-dimensionierung-und-fehlerbudgets.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](06-normgerechtes-lesbares-schema.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Simulation, Review und Design-Freigabe** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
