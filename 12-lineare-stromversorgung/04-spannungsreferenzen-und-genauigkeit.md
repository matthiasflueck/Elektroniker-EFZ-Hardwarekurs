# 12.4 – Spannungsreferenzen und Genauigkeit

[← Zurück](03-stabilitaet-esr-und-kondensatorwahl.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](05-einschaltstrom-softstart-und-sequenzierung.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Spannungsreferenzen und Genauigkeit** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
...
- [Labor 12](../praxis/lab-12.md)
- [Übungen zu Modul 12](../uebungen/modul-12.md)
- [Separate Lösungen](../loesungen/modul-12-loesungen.md)

## Bildungsplan 2026

Geplante Zuordnung: `a3`, `b1`, `b4`, `b5`, `c1`. Details: [Kompetenzmatrix](../bildungsplan/kompetenzmatrix.md).
