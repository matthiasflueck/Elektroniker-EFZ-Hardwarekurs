...
Beim Thema **Elektrischer Strom und geschlossener Stromkreis** geht es deshalb nicht nur um eine einzelne Formel oder Definition. Entscheidend ist, wie sich das Prinzip im Schema erkennen, im Datenblatt beurteilen, im Aufbau messen und bei einer Abweichung systematisch überprüfen lässt.
...
**Strom kann nur in einem geschlossenen Pfad fliessen.** Zu jedem Hinweg gehört ein Rückweg zur Quelle. Das Strompfeilsymbol legt eine positive Bezugsrichtung fest; ein negatives Messergebnis bedeutet, dass der reale Strom entgegen dieser Wahl fliesst. Ein Amperemeter wird deshalb in den Strompfad eingeschleift und darf nicht wie ein Voltmeter parallel zur Quelle angeschlossen werden.
...
- Versorgung von LED, Relais oder Mikrocontroller
- Suche nach Unterbrüchen und Kurzschlüssen
- Dimensionierung von Leiter- und Rückstrompfaden
