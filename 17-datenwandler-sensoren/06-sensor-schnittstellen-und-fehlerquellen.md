# 17.6 – Sensor-Schnittstellen und Fehlerquellen

[← Zurück](05-dac-pwm-und-rekonstruktionsfilter.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](07-kalibrierung-linearitaet-und-messunsicherheit.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Sensor-Schnittstellen und Fehlerquellen** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
...
- [Labor 17](../praxis/lab-17.md)
- [Übungen zu Modul 17](../uebungen/modul-17.md)
- [Separate Lösungen](../loesungen/modul-17-loesungen.md)

## Bildungsplan 2026

Geplante Zuordnung: `b1`, `b2`, `b4`, `b5`, `c1`, `c2`. Details: [Kompetenzmatrix](../bildungsplan/kompetenzmatrix.md).
