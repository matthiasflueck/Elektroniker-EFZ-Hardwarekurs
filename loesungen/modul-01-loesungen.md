...
1. Die Präfixe werden durch die entsprechenden Zehnerpotenzen ersetzt:
...
2. In wissenschaftlicher Schreibweise:
...
4. Beide Formeln werden mit derselben Operation auf beiden Seiten umgestellt:
...
5. Ein Prozent von **10 kΩ** entspricht **0,1 kΩ** beziehungsweise **100 Ω**:
...
9. Volt durch Kiloohm ergibt Milliampere:
...
10. Geeignete unabhängige Prüfungen sind Einheiten- beziehungsweise Dimensionsprüfung, Grössenordnung, Grenzfall und ein zweiter Weg durch Rückrechnung, Messung oder Simulation.
