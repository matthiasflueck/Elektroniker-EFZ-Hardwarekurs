# 04.5 – Gehäuse, Bauformen und Footprints

[← Zurück](04-temperaturabhaengigkeit-und-derating.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](06-lebenszyklus-verfuegbarkeit-und-alternativen.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Gehäuse, Bauformen und Footprints** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
