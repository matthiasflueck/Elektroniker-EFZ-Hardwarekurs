# 16.6 – Oszilloskop-Tastköpfe und Messbeeinflussung

[← Zurück](05-timingbudget-und-skew.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](07-layoutregeln-fuer-schnelle-digitale-signale.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Oszilloskop-Tastköpfe und Messbeeinflussung** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
...
- [Labor 16](../praxis/lab-16.md)
- [Übungen zu Modul 16](../uebungen/modul-16.md)
- [Separate Lösungen](../loesungen/modul-16-loesungen.md)

## Bildungsplan 2026

Geplante Zuordnung: `b2`, `b4`, `b5`, `c1`. Details: [Kompetenzmatrix](../bildungsplan/kompetenzmatrix.md).
