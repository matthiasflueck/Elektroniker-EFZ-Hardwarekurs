# 14.5 – Tri-State, Open Drain und Pull-Widerstände

[← Zurück](04-logikpegel-fan-out-und-noise-margin.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](06-pegelwandler-und-gemischte-versorgungsspannungen.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Tri-State, Open Drain und Pull-Widerstände** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
...
- [Labor 14](../praxis/lab-14.md)
- [Übungen zu Modul 14](../uebungen/modul-14.md)
- [Separate Lösungen](../loesungen/modul-14-loesungen.md)

## Bildungsplan 2026

Geplante Zuordnung: `b1`, `b4`, `b5`, `c5`. Details: [Kompetenzmatrix](../bildungsplan/kompetenzmatrix.md).
