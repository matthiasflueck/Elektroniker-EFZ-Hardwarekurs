# 18.2 – Reset, Boot und Programmieranschluss

[← Zurück](01-versorgung-entkopplung-und-masse.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](03-clock-quellen-und-oszillatorlayout.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Reset, Boot und Programmieranschluss** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
