# 08.6 – Halbbrücke, Totzeit und Shoot-through

[← Zurück](05-induktive-lasten-freilauf-und-avalanche.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](07-pwm-leistungsstufe-und-layout.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Halbbrücke, Totzeit und Shoot-through** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
...
- [Labor 08](../praxis/lab-08.md)
- [Übungen zu Modul 08](../uebungen/modul-08.md)
- [Separate Lösungen](../loesungen/modul-08-loesungen.md)

## Bildungsplan 2026

Geplante Zuordnung: `b1`, `b2`, `b4`, `b5`, `c1`. Details: [Kompetenzmatrix](../bildungsplan/kompetenzmatrix.md).
