# 24.5 – Funktionsgenerator, Netzgerät und elektronische Last

[← Zurück](04-tastkoepfe-stromzangen-und-differenzmessung.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](06-automatisierte-messungen-und-pruefadapter.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Funktionsgenerator, Netzgerät und elektronische Last** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
...
- [Labor 24](../praxis/lab-24.md)
- [Übungen zu Modul 24](../uebungen/modul-24.md)
- [Separate Lösungen](../loesungen/modul-24-loesungen.md)

## Bildungsplan 2026

Geplante Zuordnung: `b4`, `b5`, `c2`, `d3`, `d8`. Details: [Kompetenzmatrix](../bildungsplan/kompetenzmatrix.md).
