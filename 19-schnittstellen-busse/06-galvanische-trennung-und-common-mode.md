# 19.6 – Galvanische Trennung und Common Mode

[← Zurück](05-usb-grundlagen-und-schutz.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](07-busanalyse-mit-oszilloskop-und-logikanalysator.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Galvanische Trennung und Common Mode** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
...
- [Labor 19](../praxis/lab-19.md)
- [Übungen zu Modul 19](../uebungen/modul-19.md)
- [Separate Lösungen](../loesungen/modul-19-loesungen.md)

## Bildungsplan 2026

Geplante Zuordnung: `b1`, `b2`, `b4`, `b5`, `c1`, `c2`, `d9`. Details: [Kompetenzmatrix](../bildungsplan/kompetenzmatrix.md).
