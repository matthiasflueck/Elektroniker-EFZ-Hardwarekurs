# 22.3 – Versorgung, Masseflächen und Rückstrompfade

[← Zurück](02-bauteilplatzierung-nach-funktionsgruppen.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](04-analoge-digitale-und-leistungsfuehrende-bereiche.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Versorgung, Masseflächen und Rückstrompfade** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
...
- [Labor 22](../praxis/lab-22.md)
- [Übungen zu Modul 22](../uebungen/modul-22.md)
- [Separate Lösungen](../loesungen/modul-22-loesungen.md)

## Bildungsplan 2026

Geplante Zuordnung: `b2`, `d1`, `d2`. Details: [Kompetenzmatrix](../bildungsplan/kompetenzmatrix.md).
