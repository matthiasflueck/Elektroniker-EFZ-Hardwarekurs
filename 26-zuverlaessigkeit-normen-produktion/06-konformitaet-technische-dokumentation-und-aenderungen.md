# 26.6 – Konformität, technische Dokumentation und Änderungen

[← Zurück](05-pruefkonzept-grenzmuster-und-serienfreigabe.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](07-ecodesign-reparierbarkeit-und-lebenszyklus.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Konformität, technische Dokumentation und Änderungen** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
...
- [Labor 26](../praxis/lab-26.md)
- [Übungen zu Modul 26](../uebungen/modul-26.md)
- [Separate Lösungen](../loesungen/modul-26-loesungen.md)

## Bildungsplan 2026

Geplante Zuordnung: `a3`, `b5`, `d2`, `d3`, `d5`, `d8`. Details: [Kompetenzmatrix](../bildungsplan/kompetenzmatrix.md).
