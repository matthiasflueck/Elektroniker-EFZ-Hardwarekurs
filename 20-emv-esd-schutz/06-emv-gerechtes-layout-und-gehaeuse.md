# 20.6 – EMV-gerechtes Layout und Gehäuse

[← Zurück](05-esd-eft-und-surge-grundlagen.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](07-pre-compliance-messungen-und-abhilfen.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **EMV-gerechtes Layout und Gehäuse** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
