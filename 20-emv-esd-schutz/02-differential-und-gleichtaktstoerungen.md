# 20.2 – Differential- und Gleichtaktstörungen

[← Zurück](01-stoerquelle-kopplungspfad-und-senke.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](03-masse-erdung-und-schirmung.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Differential- und Gleichtaktstörungen** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
...
- [Labor 20](../praxis/lab-20.md)
- [Übungen zu Modul 20](../uebungen/modul-20.md)
- [Separate Lösungen](../loesungen/modul-20-loesungen.md)

## Bildungsplan 2026

Geplante Zuordnung: `a3`, `b1`, `b2`, `b4`, `b5`, `d8`. Details: [Kompetenzmatrix](../bildungsplan/kompetenzmatrix.md).
