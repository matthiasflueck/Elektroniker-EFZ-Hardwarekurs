# 03.7 – Schaltungssimulation und Plausibilitätsprüfung

[← Zurück](06-brueckenschaltungen-und-nullabgleich.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](../uebungen/modul-03.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Schaltungssimulation und Plausibilitätsprüfung** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
...
- [Labor 03](../praxis/lab-03.md)
- [Übungen zu Modul 03](../uebungen/modul-03.md)
