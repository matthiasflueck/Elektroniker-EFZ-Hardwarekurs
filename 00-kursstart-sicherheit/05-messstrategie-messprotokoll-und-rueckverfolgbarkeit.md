...
Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Messstrategie, Messprotokoll und Rückverfolgbarkeit** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
...
- [Labor 00](../praxis/lab-00.md)
- [Übungen zu Modul 00](../uebungen/modul-00.md)
- [Separate Lösungen](../loesungen/modul-00-loesungen.md)

## Bildungsplan 2026

Geplante Zuordnung: `a1`, `d1`, `d2`, `d3`. Details: [Kompetenzmatrix](../bildungsplan/kompetenzmatrix.md).
