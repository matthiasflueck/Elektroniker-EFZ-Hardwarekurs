# 13.7 – Inbetriebnahme und sichere Messung an Schaltknoten

[← Zurück](06-emv-gerechtes-power-layout.md) · [Modulübersicht](README.md) · [Kursübersicht](../README.md) · [Weiter →](../uebungen/modul-13.md)

> **Ausbaustatus:** Inhaltsskelett. Diese Lektion wird in einer späteren Ausbauphase fachlich vollständig entwickelt und geprüft.

## Lernziele

Nach dieser Lektion kannst du die zentralen Zusammenhänge von **Inbetriebnahme und sichere Messung an Schaltknoten** erklären, eine passende Schaltung oder Messung planen und das Ergebnis anhand definierter Kriterien beurteilen.
...
- [Labor 13](../praxis/lab-13.md)
- [Übungen zu Modul 13](../uebungen/modul-13.md)
- [Separate Lösungen](../loesungen/modul-13-loesungen.md)

## Bildungsplan 2026

Geplante Zuordnung: `a3`, `b1`, `b2`, `b4`, `b5`. Details: [Kompetenzmatrix](../bildungsplan/kompetenzmatrix.md).
